...
public class LinkedPriorityListTest {
	...
	public void testGenericity() {
		LinkedPriorityList<String> stringList = new LinkedPriorityList<String>();
		...
		LinkedPriorityList<Integer> intList = new LinkedPriorityList<Integer>();
		intList.insertElementAt(0, 1);
		intList.insertElementAt(0, 2);
		intList.insertElementAt(0, 3);

		LinkedPriorityList<Double> doubleList = new LinkedPriorityList<Double>();
